...
function updateTimer() {
  const targetDate = new Date("february 15, 2026 20:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '541170962193'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function () {
  // Definir los números de teléfono
  const recipientNumber1 = '541170962193'; // Número para el primer botón

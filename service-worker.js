const CACHE_NAME = 'cache-v62'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v62',
    'estilos/styles.css?v62',
    'estilos/mediaQueries.css?v62',
    'javascript/script.js?v62',
